...
if (! function_exists('_lang_routes')) {
    ...
    function _lang_routes(): array
    {
        ...
        $name = $route->getName();
        if (! str_contains($name, 'lang') && Route::has($name . '.lang')) {
            $name = $name . '.lang';
        }
...
if (! function_exists('current_lang_id')) {
    ...
    {
        return app('_lang')->getCurrent()->id;
    }
}
if (! function_exists('main_lang_id')) {
    function main_lang_id(): int
    {
        return app('_lang')->getDefault()->id;
    }
}
if (! function_exists('get_active_languages')) {
     ...
     *
     * @return \Illuminate\Support\Collection|\App\Models\Language[] Collection of Language models
     */
