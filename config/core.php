...
return [
    ...
    'kit' => [
        ...
        'components' => [
            ...
            \SmartCms\Core\Components\Form\Field::class => 'form.field',
            ...
            // \SmartCms\Core\Components\UI\Modal::class => 'ui.modal',
            // \SmartCms\Core\Components\UI\Dropdown::class => 'ui.dropdown',
            // \SmartCms\Core\Components\UI\Slideover::class => 'ui.slideover',
            // \SmartCms\Core\Components\UI\Drawer::class => 'ui.drawer',
            // \SmartCms\Core\Components\UI\Tabs::class => 'ui.tabs',
            // \SmartCms\Core\Components\UI\Button::class => 'ui.button',
            // \SmartCms\Core\Components\UI\Container::class => 'ui.container',
            // \SmartCms\Core\Components\UI\Grid::class => 'ui.grid',
            // \SmartCms\Core\Components\UI\Link::class => 'ui.link',
            // \SmartCms\Core\Components\UI\Breadcrumbs::class => 'ui.breadcrumbs',
            // \SmartCms\Core\Components\UI\Tooltip::class => 'ui.tooltip',
            // \SmartCms\Core\Components\UI\Gallery::class => 'ui.gallery',
        ],
    ],
    'resize' => [
